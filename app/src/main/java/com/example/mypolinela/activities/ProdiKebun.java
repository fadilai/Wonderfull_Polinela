...
public class ProdiKebun extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prodi_kebun);
...
//        ambil data prodi dari database
        String query_kebun = "SELECT nm_prodi,tentang,visi,misi,tujuan  FROM kebun WHERE kd_prodi = '" + kd_prodi + "'";
        Cursor cursor_kebun = db.rawQuery(query_kebun, null);
        cursor_kebun.moveToFirst();
...
//        tampilkan data prodi kedalam textview
        ...
        tv_nm_prodi.setText(cursor_kebun.getString(0));
        tv_nm_tentang.setText(cursor_kebun.getString(1));
        tv_nm_visi.setText(cursor_kebun.getString(2));
        tv_nm_misi.setText(cursor_kebun.getString(3));
        tv_nm_tujuan.setText(cursor_kebun.getString(4));
