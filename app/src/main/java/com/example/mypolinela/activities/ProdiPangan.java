...
public class ProdiPangan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prodi_pangan);
...
//        ambil data prodi dari database
        String query_pangan = "SELECT nm_prodi,tentang,visi,misi,tujuan  FROM pangan WHERE kd_prodi = '" + kd_prodi + "'";
        Cursor cursor_pangan = db.rawQuery(query_pangan, null);
        cursor_pangan.moveToFirst();
...
//        tampilkan data prodi kedalam textview
        ...
        tv_nm_prodi.setText(cursor_pangan.getString(0));
        tv_nm_tentang.setText(cursor_pangan.getString(1));
        tv_nm_visi.setText(cursor_pangan.getString(2));
        tv_nm_misi.setText(cursor_pangan.getString(3));
        tv_nm_tujuan.setText(cursor_pangan.getString(4));
