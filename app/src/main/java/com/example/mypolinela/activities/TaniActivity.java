...
public class TaniActivity extends AppCompatActivity {
...
//        ambil data prodi dari database
        String query_prodi = "SELECT kd_prodi,nm_prodi FROM tani ORDER BY kd_prodi";
...
//                TextView tv_kode_penyakit = (TextView) findViewById(R.id.kode_penyakit);
                Intent intent = new Intent(TaniActivity.this, ProdiTani.class);
    ...
    private void setupSlider() {
        ...
        //link image
        fragments.add(FragmentSlider.newInstance("https://polinela.ac.id/wp-content/uploads/2019/02/images_jurusan_teknologi_pertanian.jpg"));
