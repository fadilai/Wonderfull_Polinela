...
//        ambil data prodi dari database
        String query_prodi = "SELECT kd_prodi,nm_prodi FROM kebun ORDER BY kd_prodi";
...
//                TextView tv_kd_prodi = (TextView) findViewById(R.id.kd_prodi);
                Intent intent = new Intent(KebunActivity.this, ProdiKebun.class);
    ...
    private void setupSlider() {
        ...
        //link image
        fragments.add(FragmentSlider.newInstance("https://polinela.ac.id/wp-content/uploads/2019/02/images_jurusan_budidaya_tanaman_perkebunan.jpg"));
