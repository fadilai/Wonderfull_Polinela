...
//        ambil data prodi dari database
        String query_prodi = "SELECT kd_prodi,nm_prodi FROM pangan ORDER BY kd_prodi";
...
//                TextView tv_kode_penyakit = (TextView) findViewById(R.id.kode_penyakit);
                Intent intent = new Intent(PanganActivity.this, ProdiPangan.class);
    ...
    private void setupSlider() {
        ...
        //link image
        fragments.add(FragmentSlider.newInstance("https://polinela.ac.id/wp-content/uploads/2019/02/images_jurusan_budidaya_tanaman_pangan.jpg"));
